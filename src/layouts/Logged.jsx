          ...
          >
            <Dropdown.Menu className="left">
              {userType !== "employer" && (
                  ...
                  <Dropdown.Item as={NavLink} to={"/user-profile/"+me.id}>
              ...
              {userType === "employer" && (
                <Dropdown.Item as={NavLink} to="/add-jobadvert-by-employer">
                  <Icon name="plus square" />
                  <span className="text">Yeni İlan Oluştur</span>
                </Dropdown.Item>
              )}
              <Dropdown.Item as={NavLink} to="/favorite-job-adverts">
